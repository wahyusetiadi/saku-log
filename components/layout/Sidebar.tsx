...
import {
  ...
  Target, Settings, LogOut, Wallet, ChevronRight,
} from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-20 bg-white border-t border-surface-100"
          ...
          {navItems.map(({ href, label, icon: Icon }) => {
            ...
            return (
              <Link key={href} href={href}
                ...
                style={{
                  color: active ? "var(--color-primary-600)" : "var(--color-surface-400)",
